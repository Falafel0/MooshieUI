...
### Fixes & Polish
- Fixed release artifacts not being generated by CI (manual build with merged upstream changes)
- Updated dependencies and merged upstream/main (v2.0.9) changes
- All v2.1.0 canvas/inpaint improvements now properly packaged in release artifacts
