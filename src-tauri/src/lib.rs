...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::patchy::resolve_patchy_path,
            commands::patchy::write_patchy_document,
            commands::patchy::read_patchy_document,
            commands::patchy_live::read_patchy_live_document,
            commands::patchy_live::patchy_live_action,
            commands::patchy_live::disconnect_patchy_live,
            ...
            commands::music_review::hash_music_review_audio,
            ...
            commands::music::load_music_audio,
            commands::music::save_music_audio,
            commands::music::save_music_file,
